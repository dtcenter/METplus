export METPLUS_TEST_INPUT_BASE=/gpfs/dell2/emc/verification/noscrub/Julie.Prestopnik/METplus/METplus-3.0_sample_data
export METPLUS_TEST_OUTPUT_BASE=/gpfs/dell2/emc/verification/noscrub/Julie.Prestopnik/metplus_test
export METPLUS_TEST_MET_INSTALL_DIR=/gpfs/dell2/emc/verification/noscrub/Julie.Prestopnik/met/9.0_beta4
