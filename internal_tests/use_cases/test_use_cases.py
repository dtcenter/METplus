...
all_use_cases = [
                ...
                use_case_dir + "/met_tool_wrapper/GridStat/GridStat.conf," + use_case_dir + "/met_tool_wrapper/GridStat/GridStat_forecast.conf," + use_case_dir + "/met_tool_wrapper/GridStat/GridStat_observation.conf",
