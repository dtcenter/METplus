...
all_use_cases = [
                ...
                use_case_dir + "/met_tool_wrapper/EnsembleStat.conf",
                ...
                use_case_dir + "/met_tool_wrapper/SeriesByInit.conf",
                use_case_dir + "/met_tool_wrapper/SeriesByLead.conf",
                use_case_dir + "/met_tool_wrapper/TCPairs_A.conf",
                use_case_dir + "/met_tool_wrapper/TCPairs_B.conf",
