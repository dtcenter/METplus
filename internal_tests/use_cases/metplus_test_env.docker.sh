...
export METPLUS_TEST_OUTPUT_BASE=${OWNER_BUILD_DIR}/test-use-case-output

# location of output from previous test run to compare to current run
export METPLUS_TEST_PREV_OUTPUT_BASE=${OWNER_BUILD_DIR}/test-use-case-output-old

# location of input data to use in tests
export METPLUS_TEST_INPUT_BASE=${OWNER_BUILD_DIR}/test.metplus.data
