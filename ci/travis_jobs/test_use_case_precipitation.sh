...
curl -L -O https://github.com/NCAR/METplus/releases/download/v3.0/sample_data-precipitation-3.0.tgz
tar xfzp sample_data-precipitation-3.0.tgz
...
docker run --rm -v ${OWNER_BUILD_DIR}:/metplus ${DOCKERHUB_TAG} /bin/bash /metplus/METplus/internal_tests/use_cases/run_test_use_cases.sh docker --precipitation
