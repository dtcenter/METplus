...
@pytest.mark.parametrize(
    'config_overrides, env_var_values', [
        ...
        ({'GRID_STAT_REGRID_CONVERT': '2*x', },
         {'METPLUS_REGRID_DICT': 'regrid = {convert(x) = 2*x;}'}),

        ({'GRID_STAT_REGRID_CENSOR_THRESH': '>12000,<5000', },
         {'METPLUS_REGRID_DICT': 'regrid = {censor_thresh = [>12000, <5000];}'}),

        ({'GRID_STAT_REGRID_CENSOR_VAL': '12000,5000', },
        ...
        # fcst climo_mean
        ({'GRID_STAT_FCST_CLIMO_MEAN_FILE_NAME': '/some/climo_mean/file.txt', },
         {'METPLUS_FCST_CLIMO_MEAN_DICT': 'climo_mean = {file_name = ["/some/climo_mean/file.txt"];}'}),
        ({'GRID_STAT_FCST_CLIMO_MEAN_FIELD': '{name="UGRD"; level=["P850","P500","P250"];}', },
         {'METPLUS_FCST_CLIMO_MEAN_DICT': 'climo_mean = {field = [{name="UGRD"; level=["P850","P500","P250"];}];}'}),
        ({'GRID_STAT_FCST_CLIMO_MEAN_VAR1_NAME': 'UGRD', 'GRID_STAT_FCST_CLIMO_MEAN_VAR1_LEVELS':'P850,P500,P250', },
         {'METPLUS_FCST_CLIMO_MEAN_DICT': 'climo_mean = {field = [{ name="UGRD"; level="P850"; }, { name="UGRD"; level="P500"; }, { name="UGRD"; level="P250"; }];}'}),
        ({'GRID_STAT_FCST_CLIMO_MEAN_VAR1_NAME': 'UGRD', 'GRID_STAT_FCST_CLIMO_MEAN_VAR1_LEVELS': 'P850',
          'GRID_STAT_FCST_CLIMO_MEAN_VAR2_NAME': 'VGRD', 'GRID_STAT_FCST_CLIMO_MEAN_VAR2_LEVELS': 'P500',},
        ...
        ({'GRID_STAT_FCST_CLIMO_MEAN_FILE_NAME': '/some/climo_mean/file.txt',
          'GRID_STAT_FCST_CLIMO_MEAN_FIELD': '{name="CLM_NAME"; level="(0,0,*,*)";}',
          'GRID_STAT_FCST_CLIMO_MEAN_REGRID_METHOD': 'NEAREST',
          'GRID_STAT_FCST_CLIMO_MEAN_REGRID_WIDTH': '1',
          'GRID_STAT_FCST_CLIMO_MEAN_REGRID_VLD_THRESH': '0.5',
          'GRID_STAT_FCST_CLIMO_MEAN_REGRID_SHAPE': 'SQUARE',
        ...
        ({'GRID_STAT_FCST_CLIMO_STDEV_FIELD': '{name="UGRD"; level=["P850","P500","P250"];}', },
         {'METPLUS_FCST_CLIMO_STDEV_DICT': 'climo_stdev = {field = [{name="UGRD"; level=["P850","P500","P250"];}];}'}),
        ({'GRID_STAT_FCST_CLIMO_STDEV_VAR1_NAME': 'UGRD', 'GRID_STAT_FCST_CLIMO_STDEV_VAR1_LEVELS':'P850,P500,P250', },
         {'METPLUS_FCST_CLIMO_STDEV_DICT': 'climo_stdev = {field = [{ name="UGRD"; level="P850"; }, { name="UGRD"; level="P500"; }, { name="UGRD"; level="P250"; }];}'}),
        ({'GRID_STAT_FCST_CLIMO_STDEV_VAR1_NAME': 'UGRD', 'GRID_STAT_FCST_CLIMO_STDEV_VAR1_LEVELS': 'P850',
          'GRID_STAT_FCST_CLIMO_STDEV_VAR2_NAME': 'VGRD', 'GRID_STAT_FCST_CLIMO_STDEV_VAR2_LEVELS': 'P500',},
        ...
        ({'GRID_STAT_FCST_CLIMO_STDEV_FILE_NAME': '/some/climo_stdev/file.txt',
          'GRID_STAT_FCST_CLIMO_STDEV_FIELD': '{name="CLM_NAME"; level="(0,0,*,*)";}',
          'GRID_STAT_FCST_CLIMO_STDEV_REGRID_METHOD': 'NEAREST',
          'GRID_STAT_FCST_CLIMO_STDEV_REGRID_WIDTH': '1',
          'GRID_STAT_FCST_CLIMO_STDEV_REGRID_VLD_THRESH': '0.5',
          'GRID_STAT_FCST_CLIMO_STDEV_REGRID_SHAPE': 'SQUARE',
        ...
        ({'GRID_STAT_OBS_CLIMO_MEAN_FIELD': '{name="UGRD"; level=["P850","P500","P250"];}', },
         {'METPLUS_OBS_CLIMO_MEAN_DICT': 'climo_mean = {field = [{name="UGRD"; level=["P850","P500","P250"];}];}'}),
        ({'GRID_STAT_OBS_CLIMO_MEAN_VAR1_NAME': 'UGRD', 'GRID_STAT_OBS_CLIMO_MEAN_VAR1_LEVELS':'P850,P500,P250', },
         {'METPLUS_OBS_CLIMO_MEAN_DICT': 'climo_mean = {field = [{ name="UGRD"; level="P850"; }, { name="UGRD"; level="P500"; }, { name="UGRD"; level="P250"; }];}'}),
        ({'GRID_STAT_OBS_CLIMO_MEAN_VAR1_NAME': 'UGRD', 'GRID_STAT_OBS_CLIMO_MEAN_VAR1_LEVELS': 'P850',
          'GRID_STAT_OBS_CLIMO_MEAN_VAR2_NAME': 'VGRD', 'GRID_STAT_OBS_CLIMO_MEAN_VAR2_LEVELS': 'P500',},
        ...
        ({'GRID_STAT_OBS_CLIMO_MEAN_FILE_NAME': '/some/climo_mean/file.txt',
          'GRID_STAT_OBS_CLIMO_MEAN_FIELD': '{name="CLM_NAME"; level="(0,0,*,*)";}',
          'GRID_STAT_OBS_CLIMO_MEAN_REGRID_METHOD': 'NEAREST',
          'GRID_STAT_OBS_CLIMO_MEAN_REGRID_WIDTH': '1',
          'GRID_STAT_OBS_CLIMO_MEAN_REGRID_VLD_THRESH': '0.5',
          'GRID_STAT_OBS_CLIMO_MEAN_REGRID_SHAPE': 'SQUARE',
        ...
        ({'GRID_STAT_OBS_CLIMO_STDEV_FIELD': '{name="UGRD"; level=["P850","P500","P250"];}', },
         {'METPLUS_OBS_CLIMO_STDEV_DICT': 'climo_stdev = {field = [{name="UGRD"; level=["P850","P500","P250"];}];}'}),
        ({'GRID_STAT_OBS_CLIMO_STDEV_VAR1_NAME': 'UGRD', 'GRID_STAT_OBS_CLIMO_STDEV_VAR1_LEVELS':'P850,P500,P250', },
         {'METPLUS_OBS_CLIMO_STDEV_DICT': 'climo_stdev = {field = [{ name="UGRD"; level="P850"; }, { name="UGRD"; level="P500"; }, { name="UGRD"; level="P250"; }];}'}),
        ({'GRID_STAT_OBS_CLIMO_STDEV_VAR1_NAME': 'UGRD', 'GRID_STAT_OBS_CLIMO_STDEV_VAR1_LEVELS': 'P850',
          'GRID_STAT_OBS_CLIMO_STDEV_VAR2_NAME': 'VGRD', 'GRID_STAT_OBS_CLIMO_STDEV_VAR2_LEVELS': 'P500',},
        ...
        ({'GRID_STAT_OBS_CLIMO_STDEV_FILE_NAME': '/some/climo_stdev/file.txt',
          'GRID_STAT_OBS_CLIMO_STDEV_FIELD': '{name="CLM_NAME"; level="(0,0,*,*)";}',
          'GRID_STAT_OBS_CLIMO_STDEV_REGRID_METHOD': 'NEAREST',
          'GRID_STAT_OBS_CLIMO_STDEV_REGRID_WIDTH': '1',
          'GRID_STAT_OBS_CLIMO_STDEV_REGRID_VLD_THRESH': '0.5',
          'GRID_STAT_OBS_CLIMO_STDEV_REGRID_SHAPE': 'SQUARE',
