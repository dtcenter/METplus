...
def get_param_list(param):
    conf = metplus_home+"/internal/tests/use_cases/system.conf"
    params = param.split(",")
    params = params + [conf]
    return params
...
def main():
    ...
    parser.add_argument('--short_range', action='store_true', required=False)
    parser.add_argument('--s2s', action='store_true', required=False)
    parser.add_argument('--s2s_mid_lat', action='store_true', required=False)
    parser.add_argument('--s2s_mjo', action='store_true', required=False)
