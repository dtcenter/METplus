...
```
docker build -t dtcenter/metplus-envs:metplus_base.v5.1 -f Dockerfile.metplus_base .
docker push dtcenter/metplus-envs:metplus_base.v5.1
```
...
```
docker build -t dtcenter/metplus-envs:py_embed_base.v5.1 -f Dockerfile.py_embed_base .
docker push dtcenter/metplus-envs:py_embed_base.v5.1
```
...
```
docker build -t dtcenter/metplus-envs:h5py.v5.1 --build-arg BASE_ENV=py_embed_base.v5.1 --build-arg ENV_NAME=h5py .
docker push dtcenter/metplus-envs:h5py.v5.1
```
...
```
docker build -t dtcenter/metplus-envs:metdataio.v5.1 --build-arg ENV_NAME=metdataio .
docker push dtcenter/metplus-envs:metdataio.v5.1
```
...
```
docker build -t dtcenter/metplus-envs:pygrib.v5.1 --build-arg BASE_ENV=py_embed_base.v5.1 --build-arg ENV_NAME=pygrib .
docker push dtcenter/metplus-envs:pygrib.v5.1
```
...
```
docker build -t dtcenter/metplus-envs:cfgrib.v5.1 --build-arg ENV_NAME=cfgrib .
docker push dtcenter/metplus-envs:cfgrib.v5.1
```
...
```
docker build -t dtcenter/metplus-envs:netcdf4.v5.1 --build-arg ENV_NAME=netcdf4 .
docker push dtcenter/metplus-envs:netcdf4.v5.1
```
...
```
docker build -t dtcenter/metplus-envs:xesmf.v5.1 --build-arg ENV_NAME=xesmf .
docker push dtcenter/metplus-envs:xesmf.v5.1
```
...
```
docker build -t dtcenter/metplus-envs:spacetime.v5.1 --build-arg ENV_NAME=spacetime .
docker push dtcenter/metplus-envs:spacetime.v5.1
```
...
/home/met_test/.conda/envs/metplotpy.v5.1/bin/pip3 install .
...
cd /home/met_test/METplotpy
git checkout develop
/home/met_test/.conda/envs/weatherregime.v5.1/bin/pip3 install .
...
/home/met_test/.conda/envs/cycloneplotter.v5.1/bin/python3 cartopy_feature_download.py cultural physical
...
```
docker build -t dtcenter/metplus-envs:icecover.v5.1 --build-arg BASE_ENV=py_embed_base.v5.1 --build-arg ENV_NAME=icecover .
docker push dtcenter/metplus-envs:icecover.v5.1
```
...
```
docker build -t dtcenter/metplus-envs:gempak.v5.1 --build-arg ENV_NAME=gempak -f ./Dockerfile.gempak_env .
docker push dtcenter/metplus-envs:gempak.v5.1
```
...
```
docker build -t dtcenter/metplus-envs:gfdl-tracker.v5.1 -f ./Dockerfile.gfdl-tracker .
docker push dtcenter/metplus-envs:gfdl-tracker.v5.1
```
