...
/miniconda/miniconda3/bin/conda create -y --name ${ENV_NAME} -c conda-forge python=3.8.6
/miniconda/miniconda3/bin/conda install -y --name ${ENV_NAME} -c conda-forge python-dateutil==2.8.2
/miniconda/miniconda3/bin/conda install -y --name ${ENV_NAME} -c conda-forge matplotlib==3.5.2
/miniconda/miniconda3/bin/conda install -y --name ${ENV_NAME} -c conda-forge scipy==1.8.1
/miniconda/miniconda3/bin/conda install -y --name ${ENV_NAME} -c conda-forge plotly==5.9.0
/miniconda/miniconda3/bin/conda install -y --name ${ENV_NAME} -c conda-forge xarray==2022.3.0
/miniconda/miniconda3/bin/conda install -y --name ${ENV_NAME} -c conda-forge netcdf4==1.6.0
...
/miniconda/miniconda3/bin/conda install -y --name ${ENV_NAME} -c conda-forge imageio==2.19.3
...
/miniconda/miniconda3/bin/conda install -y --name ${ENV_NAME} -c conda-forge pint==0.19.2
/miniconda/miniconda3/bin/conda install -y --name ${ENV_NAME} -c conda-forge metpy=1.3.1
/miniconda/miniconda3/bin/conda install -y --name ${ENV_NAME} -c conda-forge pyngl==1.6.1
/miniconda/miniconda3/bin/conda install -y --name ${ENV_NAME} -c conda-forge scikit-learn==1.1.1
...
/miniconda/miniconda3/bin/conda install -y --name ${ENV_NAME} -c conda-forge pandas==1.2.3
...
/miniconda/miniconda3/bin/conda install -y --name ${ENV_NAME} -c conda-forge pytest
/miniconda/miniconda3/bin/conda install -y --name ${ENV_NAME} -c conda-forge pytest-cov
/miniconda/miniconda3/bin/conda install -y --name ${ENV_NAME} -c conda-forge numpy==1.20.1
