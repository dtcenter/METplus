...
.. glossary::
   ...
   ENSEMBLE_STAT_CLIMO_MEAN_FIELD
     ...
     :term:`ENSEMBLE_STAT_CLIMO_MEAN_VAR<n>_LEVELS`, and
     :term:`ENSEMBLE_STAT_CLIMO_MEAN_VAR<n>_OPTIONS` variables.
   ...
   ENSEMBLE_STAT_CLIMO_MEAN_VAR<n>_NAME
     ...
     variable, then :term:`ENSEMBLE_STAT_CLIMO_MEAN_FIELD` will be ignored.
     See also :term:`ENSEMBLE_STAT_CLIMO_MEAN_VAR<n>_LEVELS`
     and :term:`ENSEMBLE_STAT_CLIMO_MEAN_VAR<n>_OPTIONS`.
   ...
   ENSEMBLE_STAT_CLIMO_MEAN_VAR<n>_LEVELS
     ...
     MET configuration file for EnsembleStat. If any fields are set using this
     variable, then :term:`ENSEMBLE_STAT_CLIMO_MEAN_FIELD` will be ignored.
     See also :term:`ENSEMBLE_STAT_CLIMO_MEAN_VAR<n>_NAME`
     and :term:`ENSEMBLE_STAT_CLIMO_MEAN_VAR<n>_OPTIONS`.
   ...
   ENSEMBLE_STAT_CLIMO_MEAN_VAR<n>_OPTIONS
     ...
     variable, then :term:`ENSEMBLE_STAT_CLIMO_MEAN_FIELD` will be ignored.
     See also :term:`ENSEMBLE_STAT_CLIMO_MEAN_VAR<n>_NAME`
     and :term:`ENSEMBLE_STAT_CLIMO_MEAN_VAR<n>_LEVELS`.
   ...
   POINT_STAT_CLIMO_MEAN_FIELD
     Specify the value for 'climo_mean.field' in the MET configuration file
     for PointStat.
     The value set here must include the proper formatting that is expected in
     MET configuration file for specifying field information.
     Example: {name="TMP"; level="(*,*)";}
     ...
     :term:`POINT_STAT_CLIMO_MEAN_VAR<n>_LEVELS`, and
     :term:`POINT_STAT_CLIMO_MEAN_VAR<n>_OPTIONS` variables.
   ...
   POINT_STAT_CLIMO_MEAN_VAR<n>_NAME
     ...
     variable, then :term:`POINT_STAT_CLIMO_MEAN_FIELD` will be ignored.
     See also :term:`POINT_STAT_CLIMO_MEAN_VAR<n>_LEVELS`
     and :term:`POINT_STAT_CLIMO_MEAN_VAR<n>_OPTIONS`.
   ...
   POINT_STAT_CLIMO_MEAN_VAR<n>_LEVELS
     ...
     MET configuration file for PointStat. If any fields are set using this
     variable, then :term:`POINT_STAT_CLIMO_MEAN_FIELD` will be ignored.
     See also :term:`POINT_STAT_CLIMO_MEAN_VAR<n>_NAME`
     and :term:`POINT_STAT_CLIMO_MEAN_VAR<n>_OPTIONS`.
   ...
   POINT_STAT_CLIMO_MEAN_VAR<n>_OPTIONS
     ...
     variable, then :term:`POINT_STAT_CLIMO_MEAN_FIELD` will be ignored.
     See also :term:`POINT_STAT_CLIMO_MEAN_VAR<n>_NAME`
     and :term:`POINT_STAT_CLIMO_MEAN_VAR<n>_LEVELS`.
   ...
   GRID_STAT_CLIMO_MEAN_FIELD
     ...
     :term:`GRID_STAT_CLIMO_MEAN_VAR<n>_LEVELS`, and
     :term:`GRID_STAT_CLIMO_MEAN_VAR<n>_OPTIONS` variables.
   ...
   GRID_STAT_CLIMO_MEAN_VAR<n>_NAME
     ...
     variable, then :term:`GRID_STAT_CLIMO_MEAN_FIELD` will be ignored.
     See also :term:`GRID_STAT_CLIMO_MEAN_VAR<n>_LEVELS`
     and :term:`GRID_STAT_CLIMO_MEAN_VAR<n>_OPTIONS`.
   ...
   GRID_STAT_CLIMO_MEAN_VAR<n>_LEVELS
     ...
     MET configuration file for GridStat. If any fields are set using this
     variable, then :term:`GRID_STAT_CLIMO_MEAN_FIELD` will be ignored.
     See also :term:`GRID_STAT_CLIMO_MEAN_VAR<n>_NAME`
     and :term:`GRID_STAT_CLIMO_MEAN_VAR<n>_OPTIONS`.
   ...
   GRID_STAT_CLIMO_MEAN_VAR<n>_OPTIONS
     ...
     variable, then :term:`GRID_STAT_CLIMO_MEAN_FIELD` will be ignored.
     See also :term:`GRID_STAT_CLIMO_MEAN_VAR<n>_NAME`
     and :term:`GRID_STAT_CLIMO_MEAN_VAR<n>_LEVELS`.
   ...
   SERIES_ANALYSIS_CLIMO_MEAN_VAR<n>_NAME
     ...
     variable, then :term:`SERIES_ANALYSIS_CLIMO_MEAN_FIELD` will be ignored.
     See also :term:`SERIES_ANALYSIS_CLIMO_MEAN_VAR<n>_LEVELS`
     and :term:`SERIES_ANALYSIS_CLIMO_MEAN_VAR<n>_OPTIONS`.
   ...
   SERIES_ANALYSIS_CLIMO_MEAN_VAR<n>_LEVELS
     ...
     MET configuration file for SeriesAnalysis. If any fields are set using this
     variable, then :term:`SERIES_ANALYSIS_CLIMO_MEAN_FIELD` will be ignored.
     See also :term:`SERIES_ANALYSIS_CLIMO_MEAN_VAR<n>_NAME`
     and :term:`SERIES_ANALYSIS_CLIMO_MEAN_VAR<n>_OPTIONS`.
   ...
   SERIES_ANALYSIS_CLIMO_MEAN_VAR<n>_OPTIONS
     ...
     variable, then :term:`SERIES_ANALYSIS_CLIMO_MEAN_FIELD` will be ignored.
     See also :term:`SERIES_ANALYSIS_CLIMO_MEAN_VAR<n>_NAME`
     and :term:`SERIES_ANALYSIS_CLIMO_MEAN_VAR<n>_LEVELS`.
   ...
   GEN_ENS_PROD_CLIMO_MEAN_FIELD
     ...
     :term:`GEN_ENS_PROD_CLIMO_MEAN_VAR<n>_LEVELS`, and
     :term:`GEN_ENS_PROD_CLIMO_MEAN_VAR<n>_OPTIONS` variables.
   ...
   GEN_ENS_PROD_CLIMO_MEAN_VAR<n>_NAME
     ...
     variable, then :term:`GEN_ENS_PROD_CLIMO_MEAN_FIELD` will be ignored.
     See also :term:`GEN_ENS_PROD_CLIMO_MEAN_VAR<n>_LEVELS`
     and :term:`GEN_ENS_PROD_CLIMO_MEAN_VAR<n>_OPTIONS`.
   ...
   GEN_ENS_PROD_CLIMO_MEAN_VAR<n>_LEVELS
     ...
     MET configuration file for GenEnsProd. If any fields are set using this
     variable, then :term:`GEN_ENS_PROD_CLIMO_MEAN_FIELD` will be ignored.
     See also :term:`GEN_ENS_PROD_CLIMO_MEAN_VAR<n>_NAME`
     and :term:`GEN_ENS_PROD_CLIMO_MEAN_VAR<n>_OPTIONS`.
   ...
   GEN_ENS_PROD_CLIMO_MEAN_VAR<n>_OPTIONS
     ...
     variable, then :term:`GEN_ENS_PROD_CLIMO_MEAN_FIELD` will be ignored.
     See also :term:`GEN_ENS_PROD_CLIMO_MEAN_VAR<n>_NAME`
     and :term:`GEN_ENS_PROD_CLIMO_MEAN_VAR<n>_LEVELS`.
