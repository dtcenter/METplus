...
.. list-table:: ENSEMBLE_STAT_* variables that are no longer used
   ...
   * - Clean up ENSEMBLE_STAT_* variables
...
.. list-table:: ENSEMBLE_STAT_* variables with GEN_ENS_PROD_* variable
   :widths: 50 50
   :header-rows: 1
...
.. list-table:: ENSEMBLE_STAT_T_ENSEMBLE_FLAG_* variables with
		GEN_ENS_PROD_ENSEMBLE_FLAG_* variable
   :widths: 50
   :header-rows: 1
...
.. list-table:: ENSEMBLE_STAT_ENSEMBLE_FLAG** variables with
		ENSEMBLE_STAT_NC_ORANK_FLAG_* variable
   :widths: 50 50
   :header-rows: 1
