...
.. list-table::
   ...
   * - ENSEMBLE_STAT_OUTPUT_TEMPLATE
     - GEN_ENS_PROD_OUTPUT_TEMPLATE :raw-html:`<br />` **and add filename.**
       :raw-html:`<br />` See :ref:`below<upgrade-ensemble-case1-filename>`
...
set the ENS_VAR_<n>_\* values to the same values.
...
set the ENS_VAR_<n>_\* values to the values set for the FCST_VAR<n>_\*.
