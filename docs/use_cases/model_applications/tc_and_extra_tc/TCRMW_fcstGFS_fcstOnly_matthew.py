"""
TCRMW: Hurricane Matthew
========================

model_applications/tc_and_extra_tc/TCRMW_fcstGFS_fcstOnly_matthew.conf
...
#
# | **Init:** 2016-09-29 00Z
# | **Forecast lead:** 0, 3, 6, 9, 12, 15, 18, 21, and 24 hour
...
# with the -c option, i.e. -c parm/use_cases/model_applications/tc_and_extra_tc/TCRMW_fcstGFS_fcstOnly_matthew.conf
#
# .. highlight:: bash
# .. literalinclude:: ../../../../parm/use_cases/model_applications/tc_and_extra_tc/TCRMW_fcstGFS_fcstOnly_matthew.conf
...
#
#        master_metplus.py -c /path/to/METplus/parm/model_applications/tc_and_extra_tc/TCRMW_fcstGFS_fcstOnly_matthew.conf -c /path/to/user_system.conf
#
# 2) Modifying the configurations in parm/metplus_config, then passing in use case configuration file::
#
#        master_metplus.py -c /path/to/METplus/parm/use_cases/model_applications/tc_and_extra_tc/TCRMW_fcstGFS_fcstOnly_matthew.conf
#
...
# Output for this use case will be found in model_applications/tc_and_extra_tc/TCRMW_matthew (relative to **OUTPUT_BASE**)
