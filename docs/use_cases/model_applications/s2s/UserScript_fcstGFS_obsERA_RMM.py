...
# three plots: XXXX, XXXX, and XXXX  using sample data XXXXX
#
# The RMM plots and MJO indices calculation were created by Maria Gehne at the 
...
# with the -c option, i.e. -c parm/use_cases/model_applications/s2s/UserScript_fcstGFS_obsERA_RMM.conf
#
# .. highlight:: bash
...
#
# 1) Passing in UserScript_fcstGFS_obsERA_RMM.conf,
# then a user-specific system configuration file::
#
#        run_metplus.py \
#        -c /path/to/METplus/parm/use_cases/model_applications/s2s/UserScript_fcstGFS_obsERA_RMM.conf \
#        -c /path/to/user_system.conf
#
# 2) Modifying the configurations in parm/metplus_config, then passing in UserScript_fcstGFS_obsERA_RMM.conf::
#
#        run_metplus.py \
#        -c /path/to/METplus/parm/use_cases/model_applications/s2s/UserScript_fcstGFS_obsERA_RMM.conf
#
