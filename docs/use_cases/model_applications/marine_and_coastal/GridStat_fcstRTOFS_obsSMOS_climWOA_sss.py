...
model_applications/marine_and_coastal/GridStat_fcstRTOFS_obsSMOS_climWOA_sss.conf
...
# with the -c option, i.e. -c parm/use_cases/model_applications/marine_and_coastal/GridStat_fcstRTOFS_obsSMOS_climWOA_sss.conf
#
# .. highlight:: bash
# .. literalinclude:: ../../../../parm/use_cases/model_applications/marine_and_coastal/GridStat_fcstRTOFS_obsSMOS_climWOA_sss.conf
...
#
# parm/use_cases/model_applications/marine_and_coastal/GridStat_fcstRTOFS_obsSMOS_climWOA_sss/read_rtofs_smos_woa.py
#
# .. highlight:: python
# .. literalinclude:: ../../../../parm/use_cases/model_applications/marine_and_coastal/GridStat_fcstRTOFS_obsSMOS_climWOA_sss/read_rtofs_smos_woa.py
#
...
#
#        run_metplus.py -c /path/to/METplus/parm/use_cases/model_applications/marine_and_coastal/GridStat_fcstRTOFS_obsSMOS_climWOA_sss.conf -c /path/to/user_system.conf
#
# 2) Modifying the configurations in parm/metplus_config, then passing in GridStat_fcstRTOFS_obsSMOS_climWOA_sss.conf::
#
#        run_metplus.py -c /path/to/METplus/parm/use_cases/model_applications/marine_and_coastal/GridStat_fcstRTOFS_obsSMOS_climWOA_sss.conf
#
...
#
#
# sphinx_gallery_thumbnail_path = '_static/marine_and_coastal-GridStat_fcstRTOFS_obsSMOS_climWOA_sss.png'
