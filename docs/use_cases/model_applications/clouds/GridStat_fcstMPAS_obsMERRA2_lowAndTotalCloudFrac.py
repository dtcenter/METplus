...
#
#    run_metplus.py /path/to/METplus/parm/use_cases/model_applications/clouds/GridStat_fcstMPAS_obsMERRA2_lowAndTotalCloudFrac.conf /path/to/user_system.conf
#
...
# For the nbr instance, there will be additional netCDF fields for the fractional coverage 
