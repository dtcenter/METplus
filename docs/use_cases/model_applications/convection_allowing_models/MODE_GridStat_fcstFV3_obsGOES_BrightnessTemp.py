...
# statistics and distance maps for the forecast and observations. 

##############################################################################
# METplus Workflow
# ----------------
#
# The MODE and grid_stat tools are run for each of the 4 ensemble members and for each
...
# with the -c option, i.e. -c parm/use_cases/model_applications/convection_allowing_models/MODE_GridStat_fcstFV3_obsGOES_BrightnessTemp.conf
#
# .. highlight:: bash
# .. literalinclude:: ../../../../parm/use_cases/model_applications/convection_allowing_models/MODE_GridStat_fcstFV3_obsGOES_BrightnessTemp.conf
...
#
# 1) Passing in MODE_GridStat_fcstFV3_obsGOES_BrightnessTemp.conf then a user-specific system configuration file::
#
#        run_metplus.py -c /path/to/METplus/parm/use_cases/model_applications/convection_allowing_models/MODE_GridStat_fcstFV3_obsGOES_BrightnessTemp.conf -c /path/to/user_system.conf
#
# 2) Modifying the configurations in parm/metplus_config, then passing in MODE_GridStat_fcstFV3_obsGOES_BrightnessTemp.conf::
#
#        run_metplus.py -c /path/to/METplus/parm/use_cases/model_applications/convection_allowing_models/MODE_gridStat_fcstFV3_obsGOES_BrightnessTemp.conf
#
...
# --------
#
# sphinx_gallery_thumbnail_path = '_static/convection_allowing_models-MODE_GridStat_fcstFV3_obsGOES_BrightnessTemp.png'
#
