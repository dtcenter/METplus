...
model_applications/ral/GridStat_fcstCredit_GFS_obsGFS_6hourly.conf
...
# for 2 models, Credit and GFS for both a surface and upper air evaluation.
...
# run once.  This example loops by valid times. It processes 4 lead times for 2 valid times with 
# a total of 8 runs.  The lead times for the first valid time are listed below. 
#
# | **Init:** 2025-09-23_18Z
...
#
# .. highlight:: bash
# .. literalinclude:: ../../../../parm/use_cases/model_applications/ral/GridStat_fcstCredit_GFS_obsGFS_6hourly.conf
...
#
#   run_metplus.py /path/to/METplus/parm/use_cases/model_applications/ral/GridStat_fcstCredit_GFS_obsGFS_6hourly.conf /path/to/user_system.conf
#
...
# {OUTPUT_BASE}/model_applications/ral/GridStat_fcstCredit_GFS_obsGFS_6hourly.conf.  There will 
...
# * Credit_GFS_2025092400_2025092406_allleads_hourly_VCNT.stat
...
# * GFS_GFS_2025092400_2025092406_allleads_hourly_VCNT.stat
...
#
#
# sphinx_gallery_thumbnail_path = '_static/ral-GridStat_fcstCredit_GFS_obsGFS_6hourly.png'
