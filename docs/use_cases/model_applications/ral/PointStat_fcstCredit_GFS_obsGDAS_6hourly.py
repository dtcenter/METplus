...
model_applications/ral/PointStat_fcstCredit_GFS_obsGDAS_6hourly.conf
...
# --------------------
#
# This use case was set up as an example for verification inside RAL to 
# illustrate how to compare 2 models and also how to download data automatically.  
# The use case was originally set up to be run in real-time using the now keyword
# in VALID_BEG and VALID_END.  However, a specified date is provided here as for 
# our automated testing wor work well.  The case demonstrates how to run statistics
# for 2 models, Credit and GFS and how to make plots of ME, MAE and RMSE on some of
# the variables.  In contrast to the GridStat_fcstCredit_GFS_obsGFS_6hourly use case, 
# this case uses point observations whereast that one used gridded observations. 
...
# have an internet connection for this to work.
...
#
# .. highlight:: bash
# .. literalinclude:: ../../../../parm/use_cases/model_applications/ral/PointStat_fcstCredit_GFS_obsGDAS_6hourly.conf
...
# PointStat_fcstCredit_GFS_obsGDAS_6hourly.conf METplus configuration file.
#
...
#
#   parm/use_cases/model_applications/ral/PointStat_fcstCredit_GFS_obsGDAS_6hourly
#
# .. dropdown:: reformat_linetype.py
#
#   .. highlight:: python
#   .. literalinclude:: ../../../../parm/use_cases/model_applications/ral/PointStat_fcstCredit_GFS_obsGDAS_6hourly/reformat_linetype.py
#
# .. dropdown:: plot_line_stats.py
#
#   .. highlight:: python
#   .. literalinclude:: ../../../../parm/use_cases/model_applications/ral/PointStat_fcstCredit_GFS_obsGDAS_6hourly/plot_line_stats.py
#
# .. dropdown:: plot_line_stats_CTS.py
#
#   .. highlight:: python
#   .. literalinclude:: ../../../../parm/use_cases/model_applications/ral/PointStat_fcstCredit_GFS_obsGDAS_6hourly/plot_line_stats_CTS.py
...
#
#   run_metplus.py /path/to/METplus/parm/use_cases/model_applications/ral/PointStat_fcstCredit_GFS_obsGDAS_6hourly.conf /path/to/user_system.conf
#
...
# {OUTPUT_BASE}/model_applications/ral/PointStat_fcstCredit_GFS_obsGDAS_6hourly.  There will
...
#
#
# sphinx_gallery_thumbnail_path = '_static/ral-PointStat_fcstCredit_GFS_obsGDAS_6hourly.png'
