...
model_applications/ral/GridStat_fcstCredit_GFS_obsGFS_6hrRealtime.conf
...
# i.e. parm/use_cases/model_applications/ral/GridStat_fcstCredit_GFS_obsGFS_6hrRealtime.conf
#
# .. highlight:: bash
# .. literalinclude:: ../../../../parm/use_cases/model_applications/ral/GridStat_fcstCredit_GFS_obsGFS_6hrRealtime.conf
...
#
#   run_metplus.py /path/to/METplus/parm/use_cases/model_applications/ral/GridStat_fcstCredit_GFS_obsGFS_6hrRealtime.conf /path/to/user_system.conf
#
...
#
#
# sphinx_gallery_thumbnail_path = '_static/ral-GridStat_fcstCredit_GFS_obsGFS_6hrRealtime.png'
