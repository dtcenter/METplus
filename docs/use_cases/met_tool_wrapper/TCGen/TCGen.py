...
#
# | **Location:** All of the input data required for this use case can be found in the met_tool_wrapper sample data tarball. Click here to the METplus releases page and download sample data for the appropriate release: https://github.com/NCAR/METplus/releases
...
#
# .. note::
#  `TCGenToolUseCase <https://ncar.github.io/METplus/search.html?q=TCGenToolUseCase&check_keywords=yes&area=default>`_,
