...
#
# .. highlight:: bash
# .. literalinclude:: ../../../parm/use_cases/met_tool_wrapper/TCStat.met
#
...
#
#        master_metplus.py -c /path/to/METplus/parm/use_cases/met_tool_wrapper/TCStat.conf -c /path/to/user_system.conf
#
# 2) Modifying the configurations in parm/metplus_config, then passing in TCStat.conf::
#
#        master_metplus.py -c /path/to/METplus/parm/use_cases/met_tool_wrapper/TCStat.conf
#
