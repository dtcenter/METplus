...
# with the -c option, i.e. -c parm/use_cases/met_tool_wrapper/PCPCombine_B.conf
#
# .. highlight:: bash
# .. literalinclude:: ../../../../parm/use_cases/met_tool_wrapper/PCPCombine/PCPCombine_B.conf
...
#
# 1) Passing in PCPCombine_B.conf then a user-specific system configuration file::
#
#        master_metplus.py -c /path/to/METplus/parm/use_cases/met_tool_wrapper/PCPCombine_B.conf -c /path/to/user_system.conf
#
# 2) Modifying the configurations in parm/metplus_config, then passing in PCPCombine_B.conf::
#
#        master_metplus.py -c /path/to/METplus/parm/use_cases/met_tool_wrapper/PCPCombine_B.conf
#
...
# Output for this use case will be found in pcp_combine_add (relative to **OUTPUT_BASE**)
