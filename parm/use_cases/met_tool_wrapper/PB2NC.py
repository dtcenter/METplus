...
#
#        master_metplus.py -c /path/to/METplus/parm/use_cases/met_tool_wrapper/PB2NC.conf -c /path/to/user_system.conf
#
# 2) Modifying the configurations in parm/metplus_config, then passing in PB2NC.conf::
#
#        master_metplus.py -c /path/to/METplus/parm/use_cases/met_tool_wrapper/PB2NC.conf
#
