"""
TCPairs Extra Tropical Cyclone
==============================
...
# with the -c option, i.e. -c /path/to/TCPairs_ETC.conf
#
# .. highlight:: bash
# .. literalinclude:: ../../../../parm/use_cases/met_tool_wrapper/TCPairs/TCPairs_ETC.conf
...
#
# Passing in TCPairs_ETC.conf then a user-specific system configuration file::
#
#   master_metplus.py -c /path/to/TCPairs_ETC.conf -c /path/to/user_system.conf
#
