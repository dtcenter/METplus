...
"""
Create meridial mean statistics
...
def main():
    """
    Use existing default meridial mean config file found in METcalcpy to 
    grab the test file    
    """
    ...
    try:
        input_config_file = os.getenv("MERIDIAL_CONFIG_NAME","meridial_mean.yaml")
