...
def run_omi_steps(inlabel, inconfig, spd, EOF1, EOF2, oplot_dir):
...
def main():
    ...
    # Observations
    if run_obs_omi:
        run_omi_steps('OBS', config, spd, EOF1, EOF2, oplot_dir)

    # Forecast
    if run_fcst_omi:
        run_omi_steps('FCST', config, spd, EOF1, EOF2, oplot_dir)
