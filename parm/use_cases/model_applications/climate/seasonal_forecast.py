...
#Observational Dataset: use of the CPC precipitation reference data (same format and grid)
...
USER_CONFIG_DIR=${PROJECT_BASE_DIR}/${PROJECT}/"METplus-for-Indonesia-
   APIK/METplus_feature_281_py_embed_parm/user_config"
...
[dir]
INPUT_BASE=/home/demo/APIK/data
OUTPUT_BASE=/home/demo/APIK/output_metplus
MET_INSTALL_DIR=/opt/utilities/met/8.1
TMP_DIR=/tmp
