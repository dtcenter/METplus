...
class UsageWrapper(CommandBuilder):
    ...
    def run_all_times(self):
        print("USAGE: This text is displayed when [config] PROCESS_LIST = Usage.\n"
              "Pass in a configuration file that overrides [config] PROCESS_LIST "
              "to run other processes. For example:\n\n"
              "run_metplus.py parm/use_cases/met_tool_wrapper/GridStat/GridStat.conf\n\nor\n\n"
              "run_metplus.py parm/use_cases/model_applications/precipitation/GridStat_fcstHRRR-TLE_obsStgIV_GRIB.conf\n\n"
              "Possible processes: ")
