...
class SeriesByInitWrapper(CommandBuilder):
    ...
    def get_fcst_file_info(self, plot_input, storm_id):
        """! Get the number of all the gridded forecast n x m tile
            ...
            @param plot_input path to file generated by SeriesAnalysis. Used
            to determine the path of the ASCII file that contains a list
    ...
    def generate_plots(self, time_info, storm_list):
        ...
        for var_info in self.c_dict['VAR_LIST']:
            ...
            for storm_id in storm_list:
                ...
                num, beg, end = self.get_fcst_file_info(plot_input, storm_id)
                if num is None:
    ...
    def convert_to_png(self, ps_filename):
        ...
        convert_command = (f"self.c_dict['CONVERT_EXE'] -rotate 90 "
        ...
        self.log_error("convert returned a non-zero return "
                       f"code: {cmd}")
        self.logger.info("Check the logfile for more "
