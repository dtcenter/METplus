...
class PyEmbedIngestWrapper(LoopTimesWrapper):
    ...
    def create_c_dict(self):
        ...
        for index in indices:
            ...
            ingest_script_addons = self._get_ingest_script_addons(all_conf, index)
        ...
        self.config.set(instance, 'REGRID_DATA_PLANE_WARN_ON_DUPLICATE_OUTPUT',
                        c_dict['WARN_ON_DUPLICATE_OUTPUT'])
    ...
    @staticmethod
    def _get_ingest_script_addons(all_conf, index):
