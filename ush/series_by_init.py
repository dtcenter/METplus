...
class SeriesByInit(CommandBuilder):
    ...
    def __init__(self, p, logger):
        super(SeriesByInit, self).__init__(p, logger)
                ...
                if not storm_list:
                    ...
                    for cur_var in self.var_list:
                        ...
                        param = \
                            self.p.getstr(
                                'config',
                                'SERIES_ANALYSIS_BY_INIT_CONFIG_PATH')
