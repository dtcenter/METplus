...
class SeriesByLeadWrapper(object):
    """! @brief SeriesByLeadWrapper performs series analysis of paired data based on
    ...
    def __init__(self, config):
        ...
        self.series_anly_configuration_file = \
            config.getstr('config', 'SERIES_ANALYSIS_BY_LEAD_CONFIG_FILE')
        self.var_list = util.getlist(config.getstr('config', 'VAR_LIST'))
    ...
    def generate_plots(self, do_fhr_by_range):
        ...
        for cur_var in self.var_list:
            ...
            for cur_stat in self.stat_list:
                ...
                vmin, vmax = self.get_netcdf_min_max(do_fhr_by_range, nc_var_list,
                                                     cur_stat)
                msg = ("|INFO|[ " + cur_filename + ":" + cur_function +
...
if __name__ == "__main__":
    ...
    try:
        ...
        SBL = SeriesByLeadWrapper(CONFIG)
